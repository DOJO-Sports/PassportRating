...
public class activitySuggestionModel {
    ...
    public activitySuggestionModel(String activityType, String assetName, String assetNo, double credit,
    ...
    public activitySuggestionModel() {}
